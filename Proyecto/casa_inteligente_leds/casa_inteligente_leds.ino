...
// FUNCIONES LCD
// ============================================================
void lcdLinea(int fila, String texto) {
  if (texto.length() > 16) {
...
void procesarLineaOrg(String linea) {
  ...
  if (linea == "conf_ini") {
    ...
    lcdMostrar("Cargando .org", "Espere...");
    return;
  }
  ...
  if (linea == "conf:fin") {
    ...
    lcdMostrar("Configuracion", "guardada");
    delay(1200);
    aplicarModo(modoActual);
    return;
  }
  ...
  if (linea.startsWith("Ventilador:")) return;
